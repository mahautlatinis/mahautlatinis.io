    ...
    return (
          <div className="grid grid-cols-3 gap-1">
            <div className="space-y-1">
              <Image src={cub3d} alt="cub3d" className="transition-transform duration-300 ease-out hover:scale-90 rounded-lg" />
              ...
              <Image src={pushSwap} alt="push_swap" className="transition-transform duration-300 ease-out hover:scale-90 rounded-lg"  />
            </div>
            <div className="space-y-1">
              <Image src={ft_server} alt="ft_server" className="transition-transform duration-300 ease-out hover:scale-90 rounded-lg"  />
              <Image src={minishell} alt="minishell" className="transition-transform duration-300 ease-out hover:scale-90 rounded-lg"  />
            ...
            <div className="space-y-1">
              ...
              <Image src={ftIrc} alt="ft_irc" className="transition-transform duration-300 ease-out hover:scale-90 rounded-lg"  />
              <Image src={transcendence} alt="transcendence" className="transition-transform duration-300 ease-out hover:scale-90 rounded-lg"  />
            </div>
          </div>
    );
  }
